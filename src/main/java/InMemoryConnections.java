...
public class InMemoryConnections
{
    public static void main(String[] args) {
        ...
        passengers12.put(new Time(9), 7);
        passengers12.put(new Time(10), 6);
        lineSegments1.add(new Quintet<>(new TimeDiff(3), passengers12, 7, new LineName("1"), new StopName("C12")));
        ...
        passengers23.put(new Time(8), 6);
        lineSegments2.add(new Quintet<>(new TimeDiff(2), passengers23, 10, new LineName("2"), new StopName("C12")));
        linesList.add(new Quartet<>(new LineName("2"), new StopName("A2"), new Vector<>(Arrays.asList(new Time(3), new Time(4))), lineSegments2));
